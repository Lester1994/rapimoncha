...
public class RegistroComercio3Fragment extends Fragment implements IGenComercio {
	GoogleMap map;
	Comercio comercio;
		...
		try {
			...
			lblregresarini.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					RegistroComercio3Fragment.this.getActivity().finish();
				}
			});
	...
	public RegistroComercio3Fragment() {
		// TODO Auto-generated constructor stub
	}

	public RegistroComercio3Fragment(Comercio comercio) {
		// TODO Auto-generated constructor stub
