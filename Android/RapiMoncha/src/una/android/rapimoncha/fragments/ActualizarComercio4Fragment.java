...
public class ActualizarComercio4Fragment extends Fragment implements IGenComercio {
...
public ActualizarComercio4Fragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		lblregresarini.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				ActualizarComercio4Fragment.this.getActivity().finish();
			}
		});
