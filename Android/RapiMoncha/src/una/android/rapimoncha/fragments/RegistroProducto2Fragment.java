...
public class RegistroProducto2Fragment extends Fragment implements IGenProducto {

	private Producto producto;
	private ArrayList<Galeria> imagenes;
	private static final int RESULT_LOAD_IMAGE = 0;
	BaseAdapter adapter;
public RegistroProducto2Fragment() {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		lblregresarini.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				RegistroProducto2Fragment.this.getActivity().finish();
			}
		});
