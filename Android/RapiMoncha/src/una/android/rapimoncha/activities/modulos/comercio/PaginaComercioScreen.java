...
public class PaginaComercioScreen extends Activity {
	String[] data;
	Intent intent;
	ListView navList;
	...
	private void initCategorias() {
		new SwCategoriasComercio().obtenerCategoriasComerciod(this, categorias);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		this.idcomercio=(int)getIntent().getExtras().getInt("idcomercio");
		comercio.setIdComercio(idcomercio);
		new SwComercio().getComercioc(idcomercio, this);
